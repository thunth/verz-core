...
//			 array(
//                'name'=>'image',
//                'value'=>'CHtml::image(ImageHelper::getImageUrl($data, "large_image", "adminthumb"),"attament",array("style"=>"width:200px;"))',
//                'type'=>"raw",
//                ),
            'banner_title',
             array(
                'name'=>'group_banner_id',
                'value'=>'GroupBanner::model()->find("id = ".$data->group_banner_id."")->name',
            ),
            array(
                'name' => 'order_display',
