			...
			<div class="form-group form-group-sm">
				...
				<div class="col-sm-3">
					...
					<?php echo $form->error($model, 'email'); ?>
                        ...
                        <div class="form-group form-group-sm">
				<?php echo $form->labelEx($model, 'role_id', array('class' => "col-sm-1 control-label")); ?>
				<div class="col-sm-3">
                                    <?php echo $form->dropDownList($model, 'role_id', Roles::loadItems(), array('class' => 'form-control', 'empty'=>'Select')); ?>
