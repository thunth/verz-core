<div class="panel panel-default">
  <div class="panel-body">
	<?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <div class="col-sm-4">
		<div class="form-group form-group-sm">
			<?php echo $form->label($model,'role_id', array('class' => "col-sm-3 control-label")); ?>
			<div class="col-sm-7">
				<?php echo $form->dropDownList($model,'role_id', Roles::loadItems(),array('empty'=>'', 'class' => "form-control"));?>
			</div>
		</div>
	</div>
