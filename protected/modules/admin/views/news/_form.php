<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="form-group form-group-sm">
			<label class="col-sm-1 control-label">Associated Categories</label>
			<div class="col-sm-3">
				<?php echo $form->dropDownList($model, 'categoryId', NewsCategory::model()->categoryDropdownBackend(), array('data-placeholder' => 'Select Associate Category', 'class' => 'chosen-select', 'multiple' => "multiple")); ?>
