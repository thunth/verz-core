<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="form">
            ...
            <div class='form-group form-group-sm'>
                <?php echo $form->labelEx($model, 'gender', array('class' => 'col-sm-1 control-label')); ?>
                <div class="col-sm-3">
                    <?php echo $form->dropDownList($model, 'gender',$model->optionGender, array('class' => 'form-control', 'maxlength' => 255)); ?>
