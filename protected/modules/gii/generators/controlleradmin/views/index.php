...
<script type="text/javascript">
    $(document).ready(function(){
        $('body').on('click', '.load-attribute', function(e) {
...
//        $('.add_attribute_index').live('click', function(e) {
        $('body').on('click', '.add_attribute_index', function(e) {
            e.preventDefault();
            var model = $('#ControlleradminCode_model_name').val();
            $.ajax({
               type: 'POST',
...
//        $('.add_attribute_view').live('click', function(e) {
        $('body').on('click', '.add_attribute_view', function(e) {
            e.preventDefault();
            var model = $('#ControlleradminCode_model_name').val();
            $.ajax({
               type: 'POST',
...
//        $('.more_attr').live('change', function(e) {
        $('body').on('click', '.more_attr', function(e) {
...
//        $( "#ControlleradminCode_model_name" ).live('focus.autocomplete', function(){
        $('body').on('focus.autocomplete', '#ControlleradminCode_model_name', function(e) {
            <?php
