...
class Menuitem extends _BaseModel
{
	...
	public function relations()
	{
		...
		return array(
            ...
            'parent_fk' => array(self::BELONGS_TO, 'Menuitem', 'parent_id'),
		);
	}
	...
	*/
    ...
    public static function findActiveByMenu($menu, $showAll = true) {
        $criteria=new CDbCriteria;
    ...
    public static function getModelIdFromDataId($dataId, $models){
        foreach ($models as $model) {
            if ((string)$model->menuDataId==(string)$dataId) return $model->id;
        }
        return 0;
    }
