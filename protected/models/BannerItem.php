...
class BannerItem extends _BaseModel
{
	...
	public $defineImageSize = array('large_image' => array(
													...
													array('alias' => 'adminthumb', 'size' => '137x100'),
													array('alias' => 'pagethumb', 'size' => '705x206'),
												)
	);
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('banner_title,banner_description', 'required', 'on' => 'create, update'),
...
//	}
	...
	{
		$models = self::model()->findAll(array('condition' => 'group_banner_id = ' . (int)$group_id, 'order' => 'order_display asc'));
		return $models;
	}
